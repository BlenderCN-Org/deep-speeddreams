...
//
// $Id: iochannel.hxx,v 1.6 2006-03-08 18:16:08 mfranz Exp $
...
#define M_IO_MAX_MSG_SIZE 16384
...
public:
     ...
     */
    virtual bool open( const MProtocolDir d );
    ...
    inline void set_type( MChannelType t ) { type = t; }
    inline MChannelType get_type() const { return type; }

    inline void set_dir( const MProtocolDir d ) { dir = d; }
    inline MProtocolDir get_dir() const { return dir; }
