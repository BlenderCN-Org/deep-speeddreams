...
//
// $Id: metar.hxx,v 1.9 2006-03-08 18:16:08 mfranz Exp $
...
public:
	...
	inline const MMetarVisibility&	getMinVisibility()	const { return _min_visibility; }
	inline const MMetarVisibility&	getMaxVisibility()	const { return _max_visibility; }

protected:
	MMetarVisibility _min_visibility;
	MMetarVisibility _max_visibility;
	int		_deposit;
...
{
public:
	MMetar(const string& m, const string& proxy = "", const string& port = "",
	...
	inline const MMetarVisibility& getMinVisibility()	const { return _min_visibility; }
	inline const MMetarVisibility& getMaxVisibility()	const { return _max_visibility; }
	inline const MMetarVisibility& getVertVisibility()	const { return _vert_visibility; }
	inline const MMetarVisibility *getDirVisibility()	const { return _dir_visibility; }
	...
	inline const vector<MMetarCloud>& getClouds()	const	{ return _clouds; }
	inline const map<string, MMetarRunway>& getRunways()	const	{ return _runways; }
...
protected:
	...
	MMetarVisibility		_min_visibility;
	MMetarVisibility		_max_visibility;
	MMetarVisibility		_vert_visibility;
	MMetarVisibility		_dir_visibility[8];
	vector<MMetarCloud>		_clouds;
	map<string, MMetarRunway>	_runways;
